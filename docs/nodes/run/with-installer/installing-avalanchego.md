---
tags: [Nodes]
description: In this tutorial, you'll learn how to download and install AvalancheGo using the installation script.
sidebar_label: Installing AvalancheGo
sidebar_position: 1
---

# Installing AvalancheGo Using the Script
