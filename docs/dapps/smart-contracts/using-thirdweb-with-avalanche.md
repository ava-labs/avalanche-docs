# Using thirdweb with the Avalanche C-Chain
...
5. After modifying your contract with your desired custom logic, you may deploy it to Avalanche using [Deploy](https://portal.thirdweb.com/deploy).
