...
The `foundry.toml` by default points to the folders it added. We will want to change this to make sure the `src` points to the our `contracts` directory. Change your `foundry.toml` to look like the following:
