...
smart contracts. It requires some initial project configuration in the form of a [foundry.toml](https://github.com/foundry-rs/foundry#configuration) which can be generated by running:
...
```zsh
forge create NFT --rpc-url=$RPC_URL --private-key=$PRIVATE_KEY --constructor-args GameItem ITM -c contracts/
```
