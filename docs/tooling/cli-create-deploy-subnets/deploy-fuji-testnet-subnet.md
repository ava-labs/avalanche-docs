...
[Run an Avalanche Node Manually](/nodes/run/node-manually.md)
...
[it only needs 1 AVAX to become a validator on the Fuji Testnet](/nodes/validate/how-to-stake.md#fuji-testnet)
...
[local network](tooling/cli-create-deploy-subnets/create-subnet.md#create-your-subnet-configuration). In fact,
