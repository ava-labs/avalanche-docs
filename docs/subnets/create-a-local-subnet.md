...
Heres an example of our Fuji Network config from the [Avalanche smart contract quickstart repo:](https://github.com/ava-labs/avalanche-smart-contract-quickstart)
