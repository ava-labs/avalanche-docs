...
"chainId": 11111
```
Put a unique number as chain id for your chain. Conflicting chain ids can cause problems. You can read more about all of these parameters [here](../subnets/create-a-fuji-subnet.md#create-the-genesis-data).
