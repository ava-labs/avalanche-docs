...
Also, this tutorial assumes that a node is up and running, fully bootstrapped on `Mainnet`, and is being
...
For the success case, the Subnet id is going to be created, taking 1 AVAX from the ledger address,
