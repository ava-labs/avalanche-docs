...
To check on your new Subnet, visit [Avalanche Explorer](https://subnets.avax.network/). The search works by P-Chain TXID,
...
You can check for P-Chain TXID information on [Avalanche Explorer](https://subnets.avax.network/)
