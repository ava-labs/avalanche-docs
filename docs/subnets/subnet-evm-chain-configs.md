...
This works together 
with [`allowFeeRecipients`](../subnets/subnet-evm-genesis-file.md#setting-a-custom-fee-recipient) 
and [RewardManager precompile](../subnets/subnet-evm-precompiles#changing-fee-reward-mechanisms) 
