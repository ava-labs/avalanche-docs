...
with the Admin API enabled, use [C-Chain config flag`--coreth-admin-api-enabled:true`](/nodes/configure/chain-configs/chain-config-flags.md#coreth-admin-api-enabled-boolean).
