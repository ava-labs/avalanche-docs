...
# Indexing Avalanche C-Chain and Subnet data via Flair
...
{
  "cluster": "dev",
  "namespace": "my-awesome-avalanche-indexing-dev",
  "indexers": [
    {
      "chainId": 43114,
      "enabled": true,
...
pnpm flair backfill --chain 43114 --address 
0x546e402d6e9a625bd17fc31a672d91df85527cfc -d backward --max-blocks 10000
# backfill for a specific block number, if you have certain events you wanna test with
pnpm flair backfill --chain 43114 -b 36781273
# backfill for the recent data in the last X minute
pnpm flair backfill --chain 43114 --min-timestamp="30 mins ago" -d backward
```
