...
Send an asset from the X-Chain to the P-Chain or C-Chain. After calling this method, you must call the [C-Chain's `avax.import`](c-chain.md#avaximport) or the [P-Chain's `avax.importAVAX`](p-chain.md#avax-importAVAX) to complete the transfer.
