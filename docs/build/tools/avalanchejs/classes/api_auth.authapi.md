...
*Defined in [src/apis/auth/api.ts:89](https://github.com/ava-labs/avalanchejs/blob/fa4a637/src/apis/auth/api.ts#L89)*
...
*Defined in [src/apis/auth/api.ts:76](https://github.com/ava-labs/avalanchejs/blob/fa4a637/src/apis/auth/api.ts#L76)*
...
*Defined in [src/apis/auth/api.ts:31](https://github.com/ava-labs/avalanchejs/blob/fa4a637/src/apis/auth/api.ts#L31)*
...
*Defined in [src/apis/auth/api.ts:56](https://github.com/ava-labs/avalanchejs/blob/fa4a637/src/apis/auth/api.ts#L56)*
