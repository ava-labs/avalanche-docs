...
The Warp Precompile is broken down into three functions defined in the Solidity interface file [here](https://github.com/meaghanfitzgerald/coreth/blob/docs-integration/contracts/contracts/interfaces/IWarpMessenger.sol).
...
This pre-verification is performed using the ProposerVM Block header during [block verification](https://github.com/meaghanfitzgerald/coreth/blob/docs-integration/plugin/evm/block.go#L220) and [block building](https://github.com/meaghanfitzgerald/coreth/blob/docs-integration/miner/worker.go#L200).
...
Avalanche Warp Messages are encoded as a signed Avalanche [Warp Message](https://github.com/ava-labs/avalanchego/blob/master/vms/platformvm/warp/message.go#L7) where the [UnsignedMessage](https://github.com/ava-labs/avalanchego/blob/master/vms/platformvm/warp/unsigned_message.go#L14)'s payload includes an [AddressedPayload](https://github.com/meaghanfitzgerald/coreth/blob/docs-integration/warp/payload/payload.go).
...
Therefore, we use the [Predicate Utils](https://github.com/meaghanfitzgerald/coreth/blob/docs-integration/utils/predicate/README.md) package to encode the actual byte slice of size N into the access list.
