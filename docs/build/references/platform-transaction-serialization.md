...
* codec id: 00 00 
* type id: 00 00 00 0f 
* network id: 00 00 05 39 
* blockchain id: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 

* num outs: 00 00 00 01 
* out 1: 
* asset id: 17 cc 8b 15 78 ba 38 35 44 d1 63 95 88 22 d8 ab d3 84 9b b9 df ab e3 9f cb c3 e7 ee 88 11 fe 2f 
* type id: 00 00 00 07 
* amount: 00 23 86 f2 5d df 5d 00 
* locktime: 00 00 00 00 00 00 00 00 
* threshold: 00 00 00 01 
* num addrs: 00 00 00 01 
* addr 1: 3c b7 d3 84 2e 8c ee 6a 0e bd 09 f1 fe 88 4f 68 61 e1 b2 9c 

* num ins: 00 00 00 01 
* in 1:
* tx id: ca d6 55 32 96 97 86 0b cf 5e 82 37 4b f2 2c ae e1 02 1a 1c 48 21 d6 c6 b9 64 db 18 87 f5 fe 5e 
* utxo index: 00 00 00 00 
* asset id: 17 cc 8b 15 78 ba 38 35 44 d1 63 95 88 22 d8 ab d3 84 9b b9 df ab e3 9f cb c3 e7 ee 88 11 fe 2f 
* type id: 00 00 00 05 
* amount: 00 23 86 f2 63 d5 3e 00 
* num addr indices: 00 00 00 01 
* addr index 1: 00 00 00 00

* memo: 00 00 00 00 
// end base tx

* subnet id: 8c 86 d0 7c d6 02 18 66 18 63 e0 11 65 52 dc cd 5b d8 4c 56 4b d2 9d 71 81 db dd d5 ec 61 61 04 

* chain name length: 00 0c 
* chain name: 4d 79 20 6e 65 77 20 61 76 6d 20 32 
* vm id: 61 76 6d 
]
```
