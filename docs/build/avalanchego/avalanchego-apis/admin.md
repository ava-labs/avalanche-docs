...
Dynamically loads any virtual machines installed on the node as plugins. See [here](../../tutorials/subnets/create-a-virtual-machine-vm.md/#installing-a-vm) for more information on how to install a virtual machine on a node.
