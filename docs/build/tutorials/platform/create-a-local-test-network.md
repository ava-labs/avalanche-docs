...
* Using the [Avalanche Network Runner](../../tools/netrunner.md)
...
### Using the Avalanche Network Runner
...
After you run the above command, check the output to see the API port of each node. The output will look something like this:
...
Once you have a node's API port, you can make API calls to it as in the examples above.
