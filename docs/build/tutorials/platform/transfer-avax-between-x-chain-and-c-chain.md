...
Use the address corresponding to the private key you exported and switch to using the C- prefix in the [`avm.export`](../../avalanchego/avalanchego-apis/x-chain.mdx#avmexport) call:
...
To finish the transfer, call [`avm.import`](../../avalanchego/avalanchego-apis/x-chain.mdx#avmimport).
