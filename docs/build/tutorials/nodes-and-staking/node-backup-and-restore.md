...
You can now check that the node is restored with the correct NodeID by issuing the [getNodeID](https://docs.avax.network/build/avalanchego/avalanchego-apis/info#info-getnodeid) API call in the same console you ran the previous command:
