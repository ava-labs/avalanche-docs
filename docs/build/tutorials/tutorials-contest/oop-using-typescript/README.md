...
In this tutorial we're going to be learning about Typescript and Object Oriented programming(OOP) coding patterns by creating a simple Blockchain class.  
