...
curl -X POST --data '{
    "jsonrpc": "2.0",
    "id"     : 1,
    "method" : "vertex.getVertex",
    "params" : {
        "vertexID": "FwTDoE9f2T6JezQwfhqs9NdTB8fYavkG8e4Jn4wezFh21qzio",
        "encoding": "json"
    }
}' -H 'content-type:application/json;' 127.0.0.1:9650/ext/bc/X/vertex
```
...
```json
{
  ...
  "result": {
    "vertex": {
      ...
      "epoch": 0,
      "parentIDs": [
        "2awsMGhSo1axbE7wCxUh3pETfQNxTfBGimZz6eaj5tmjo4JiCE"
      ],
      "txs": [
        ""
      ]
    },
    "encoding": "json"
  },
...
```json
{
  "jsonrpc": "2.0",
  "result": {
    "vertex": "",
    "encoding": "cb58"
  },
  "id": 1
}
...
```json
{
  "jsonrpc": "2.0",
  "result": {
    "vertex": "",
    "encoding": "hex"
  },
  "id": 1
}
