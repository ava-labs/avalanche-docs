...
[Staking](../../../nodes/validate/staking.md)
...
* `from` are the fund addresses that you want to use to pay for this operation. If omitted, uses any of user's addresses as needed.
