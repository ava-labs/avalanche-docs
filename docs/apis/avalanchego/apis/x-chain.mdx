...
The [X-Chain](../../../overview/getting-started/avalanche-platform-overview.md#exchange-chain-x-chain), Avalanche’s native platform for creating and trading assets, is an instance of the Avalanche Virtual Machine (AVM). This API allows clients to create and trade assets on the X-Chain and other instances of the AVM.
...
Create a new fixed-cap, fungible asset. A quantity of it is created at initialization and then no more is ever created. The asset can be sent with `avm.send`. More details can be found [here](../../../dapps/smart-digital-assets/create-a-fix-cap-asset.md).
...
Create a new variable-cap, fungible asset. No units of the asset exist at initialization. Minters can mint units of this asset using `avm.mint`. More details can be found [here](../../../dapps/smart-digital-assets/creating-a-variable-cap-asset.md).
...
Create a new non-fungible asset. No units of the asset exist at initialization. Minters can mint units of this asset using `avm.mintNFT`. More details can be found [here](../../../dapps/smart-digital-assets/creating-a-nft-part-1.md).
...
Mint non-fungible tokens which were created with [`avm.createNFTAsset`](x-chain.mdx#avmcreatenftasset). More details can be found [here](../../../dapps/smart-digital-assets/creating-a-nft-part-1.md).
