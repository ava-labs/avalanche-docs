...
Here are tutorials on [creating a subnet](../../build/tutorials/platform/subnets/create-a-subnet.md) and [adding validators](../../build/tutorials/nodes-and-staking/validate/add-a-validator.md) to a subnet.
