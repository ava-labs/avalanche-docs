...
The base fee can go as low as 25 nAVAX (GWei) and as high as 1000 nAVAX (GWei) after AP4. We recommend that users switch to using the [eth\_baseFee](../../build/avalanchego-apis/contract-chain-c-chain-api#eth_basefee) and [eth\_maxPriorityFeePerGas](../../build/avalanchego-apis/contract-chain-c-chain-api#eth_maxpriorityfeepergas) API methods to estimate what fee to use in their transactions.
