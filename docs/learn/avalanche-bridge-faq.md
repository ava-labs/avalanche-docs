...
* **USERS MUST NOT SEND FUNDS DIRECTLY TO ANY AVALANCHE BRIDGE’S CONTRACT ADDRESSES.** The Avalanche Bridge should only be accessed through the Avalanche Bridge’s UI, located [here](https://bridge.avax.network/). Any funds sent directly to the Avalanche Bridge’s contract addresses will be permanently lost and not recoverable.
* **USERS MUST NOT SEND FUNDS DIRECTLY TO ANY AVALANCHE BRIDGE’S WALLET ADDRESSES.** The Avalanche Bridge should only be accessed through the Avalanche Bridge’s UI, located [here](https://bridge.avax.network/). Any funds sent directly to the Avalanche Bridge’s wallet addresses will be permanently lost and not recoverable.
