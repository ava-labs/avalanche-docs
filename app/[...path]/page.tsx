...
const staticRedirects: RedirectMap = {
  ...
  '/tooling/avalanche-cli': '/tooling/cli-commands',
  '/tooling/guide/get-avalanche-cli': '/tooling/get-avalanche-cli',
  '/tooling/create-deploy-avalanche-l1s/create-avalanche-l1': '/tooling/create-avalanche-l1',
  '/avalanche-l1s/build-first-avalanche-l1': '/tooling/create-avalanche-l1',
  '/avalanche-l1s/deploy-a-avalanche-l1/fuji-testnet': '/tooling/create-deploy-avalanche-l1s/deploy-locally',
  '/avalanche-l1s/deploy-a-avalanche-l1/avalanche-mainnet': '/tooling/create-deploy-avalanche-l1s/deploy-on-mainnet',
  ...
  '/avalanche-l1s/deploy-a-avalanche-l1/multisig-auth': '/tooling/create-deploy-avalanche-l1s/deploy-with-multisig-auth',
  '/avalanche-l1s/deploy-a-avalanche-l1/custom-virtual-machine': '/tooling/create-deploy-avalanche-l1s/deploy-with-custom-vm',
  '/avalanche-l1s/maintain/transfer-pchain-funds': '/tooling/transactions/ledger-p-chain-transfer',
  '/avalanche-l1s/maintain/add-validator-l1': '/tooling/maintain/add-validator-l1',
  '/avalanche-l1s/maintain/remove-validator-l1': '/tooling/maintain/remove-validator-l1',
  '/avalanche-l1s/maintain/view-avalanche-l1s': '/tooling/maintain/view-avalanche-l1s',
  '/avalanche-l1s/maintain/delete-avalanche-l1': '/tooling/maintain/delete-avalanche-l1',
  '/avalanche-l1s/troubleshooting': '/tooling/maintain/troubleshooting',
  '/avalanche-l1s/upgrade/avalanche-l1-precompile-config': '/tooling/upgrade/avalanche-l1-precompile-config',
  '/avalanche-l1s/upgrade/avalanche-l1-virtual-machine': '/tooling/upgrade/avalanche-l1-virtual-machine',
  '/evm-l1s': '/virtual-machines/evm-l1-customization',
  '/evm-l1s/validator-manager/poa-vs-pos': '/avalanche-l1s/validator-manager/poa-vs-pos',
  '/evm-l1s/validator-manager/contract': '/avalanche-l1s/validator-manager/contract',
  '/evm-l1s/validator-manager/add-validator': '/avalanche-l1s/validator-manager/add-validator',
  '/evm-l1s/validator-manager/remove-validator': '/avalanche-l1s/validator-manager/remove-validator',
  '/evm-l1s/validator-manager/upgrade': '/avalanche-l1s/validator-manager/upgrade',
  '/evm-l1s/validator-manager/custom-validator-manager': '/avalanche-l1s/validator-manager/custom-validator-manager',
  '/evm-l1s/default-precompiles/overview': '/virtual-machines/default-precompiles',
  '/evm-l1s/default-precompiles/allowlist': '/virtual-machines/default-precompiles/allowlist',
  '/evm-l1s/default-precompiles/rewardmanager': '/virtual-machines/default-precompiles/rewardmanager',
  '/evm-l1s/default-precompiles/feemanager': '/virtual-machines/default-precompiles/feemanager',
  '/evm-l1s/default-precompiles/nativeminter': '/virtual-machines/default-precompiles/nativeminter',
  '/evm-l1s/default-precompiles/warpmessenger': '/virtual-machines/default-precompiles/warpmessenger',
  '/evm-l1s/custom-precompiles/introduction': '/virtual-machines/custom-precompiles',
  '/evm-l1s/custom-precompiles/background-requirements': '/virtual-machines/custom-precompiles/background-requirements',
  '/evm-l1s/custom-precompiles/generating-your-precompile': '/virtual-machines/custom-precompiles/create-precompile',
  '/evm-l1s/custom-precompiles/defining-your-precompile': '/virtual-machines/custom-precompiles/defining-precompile',
  '/evm-l1s/custom-precompiles/writing-test-cases': '/virtual-machines/custom-precompiles/defining-test-cases',
  '/evm-l1s/custom-precompiles/executing-test-cases': '/virtual-machines/custom-precompiles/executing-test-cases',
