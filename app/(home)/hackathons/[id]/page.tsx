...
import PricesTrakcs from "@/components/hackathons/details/pricesTracks";
            ...
            <section>
              ...
              <div className="absolute left-0 w-screen py-32 px-20 grid grid-cols-4 items-center content-center gap-8 bg-zinc-200">
                {hackathon.content.tracks.map((track, index) => (
                  <div key={index} className="relative w-full h-44 p-8 bg-zinc-900 rounded-xl border-zinc-800 border-2">
