...
Bu metot çağrılmadan önce, transferi başlatmak için X-Chain'in [`avm.export`](exchange-chain-x-chain-api.mdx#avm-export) metodunu `AVAX` varlık kimliği ile çağırmanız gerekir.
