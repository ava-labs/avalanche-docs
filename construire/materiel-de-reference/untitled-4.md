...
This page is meant to be the single source of truth for how we serialize atomic transactions in `Coreth`. This document uses the [primitive serialization](untitled-4.md) format for packing and [secp256k1](untitled-4.md) for cryptographic user identification.
