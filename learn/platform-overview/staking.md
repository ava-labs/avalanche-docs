...
* The minimum percentage of the time a validator must be online and responsive in order to receive a reward is 80% (according to the view of the majority of stake at the time a validator's staking period ends). Because other validators may join the staking set at any time during a validator's staking period (forming an opinion on a validator's performance based on an interval shorter than a validator's entire staking duration), **you should aim to have your validator be online and responsive 100% of the time.** If your node's uptime, as shown on Avalanche's [staking dashboard](https://stats.avax.network/dashboard/staking/), is not close to 100%, there may be something wrong with your node setup, which may jeopardize your staking reward. If this is the case, please contact us on [Discord](https://chat.avax.network) and we can help debug.
