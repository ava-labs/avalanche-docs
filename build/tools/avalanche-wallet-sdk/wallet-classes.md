...
Las billeteras Mnemonic están diseñadas de acuerdo con las especificaciones de BIP44, BIP32 y BIP39. Para cada transacción recibida, la billetera mnemonic genera una nueva dirección. Esto aumenta la privacidad pero disminuye el rendimiento para este tipo de billetera.
...
### Desde una frase Mnemónica existente
...
## Billetera Mnemónica pública

Similar a la clase MnemonicWallet pero en modo de lectura sin acceso a la frase de semillas.
...
Similar a la clase MnemonicWallet En vez de tener acceso a una frase de semillas, se comunica con un dispositivo de libro de libro externo para firmar transacciones.

La aplicación del cliente necesita proporcionar el [transporte de libro de libro de libro](https://github.com/LedgerHQ/ledgerjs#ledgerhqhw-transport-) apropiado.
...
## Billetera de Singleton

Las billeteras de Singleton son el tipo de billetera más performante porque consisten en una sola llave privada, con una dirección individual.
