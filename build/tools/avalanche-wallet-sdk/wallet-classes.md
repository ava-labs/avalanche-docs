...
Le noyau du SDK sont les classes de portefeuille qui permettent aux utilisateurs de créer et de gérer différents types de portefeuilles.

## Portefeuille Mnémonique

Les portefeuilles Mnémoniques sont conçus selon les spécifications BIP44, BIP32 et BIP39. Pour chaque transaction reçue, le portefeuille mnémonique génère une nouvelle adresse. Cela augmente la vie privée, mais diminue la performance de ce type de portefeuille.
...
### À partir d'une Phrase Mnémonique existante
...
## Portefeuille Mnémonique public
...
Similaire à la classe MnemonicWallet Au lieu d'avoir accès à une phrase de semence, il communique avec un périphérique du grand livre externe pour signer les transactions.

L'application client doit fournir le transport approprié [du livre](https://github.com/LedgerHQ/ledgerjs#ledgerhqhw-transport-).
