...
*Defined in [src/apis/auth/api.ts:67](https://github.com/ava-labs/avalanchejs/blob/ccc6083/src/apis/auth/api.ts#L67)*
...
*Defined in [src/apis/auth/api.ts:60](https://github.com/ava-labs/avalanchejs/blob/ccc6083/src/apis/auth/api.ts#L60)*
...
*Defined in [src/apis/auth/api.ts:25](https://github.com/ava-labs/avalanchejs/blob/ccc6083/src/apis/auth/api.ts#L25)*
...
*Defined in [src/apis/auth/api.ts:43](https://github.com/ava-labs/avalanchejs/blob/ccc6083/src/apis/auth/api.ts#L43)*
