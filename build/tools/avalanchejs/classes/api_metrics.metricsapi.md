...
*Defined in [src/apis/metrics/api.ts:32](https://github.com/ava-labs/avalanchejs/blob/40de7e6/src/apis/metrics/api.ts#L32)*
...
*Defined in [src/apis/metrics/api.ts:19](https://github.com/ava-labs/avalanchejs/blob/40de7e6/src/apis/metrics/api.ts#L19)*
...
*Defined in [src/apis/metrics/api.ts:31](https://github.com/ava-labs/avalanchejs/blob/40de7e6/src/apis/metrics/api.ts#L31)*
