...
*Defined in [src/apis/health/api.ts:23](https://github.com/ava-labs/avalanchejs/blob/1a2866a/src/apis/health/api.ts#L23)*
...
*Defined in [src/apis/health/api.ts:22](https://github.com/ava-labs/avalanchejs/blob/1a2866a/src/apis/health/api.ts#L22)*
