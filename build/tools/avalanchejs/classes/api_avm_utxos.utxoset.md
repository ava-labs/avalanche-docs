...
*Defined in [src/apis/avm/utxos.ts:115](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/avm/utxos.ts#L115)*
...
*Defined in [src/apis/avm/utxos.ts:114](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/avm/utxos.ts#L114)*
...
*Defined in [src/common/utxos.ts:194](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L194)*
...
*Defined in [src/common/utxos.ts:193](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L193)*
...
*Defined in [src/apis/avm/utxos.ts:166](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/avm/utxos.ts#L166)*
...
*Defined in [src/common/utxos.ts:228](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L228)*
...
*Defined in [src/common/utxos.ts:266](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L266)*
...
*Defined in [src/apis/avm/utxos.ts:262](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/avm/utxos.ts#L262)*

Creates an [UnsignedTx](api_platformvm_transactions.unsignedtx.md) wrapping a [BaseTx](api_platformvm_basetx.basetx.md). For more granular control, you may create your own
[UnsignedTx](api_platformvm_transactions.unsignedtx.md) wrapping a [BaseTx](api_platformvm_basetx.basetx.md) manually (with their corresponding [TransferableInput](api_platformvm_inputs.transferableinput.md)s and [TransferableOutput](api_platformvm_outputs.transferableoutput.md)s).
...
*Defined in [src/apis/avm/utxos.ts:344](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/avm/utxos.ts#L344)*

Creates an unsigned Create Asset transaction. For more granular control, you may create your own
[[CreateAssetTX]] manually (with their corresponding [TransferableInput](api_platformvm_inputs.transferableinput.md)s, [TransferableOutput](api_platformvm_outputs.transferableoutput.md)s).
...
*Defined in [src/apis/avm/utxos.ts:482](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/avm/utxos.ts#L482)*
...
*Defined in [src/apis/avm/utxos.ts:546](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/avm/utxos.ts#L546)*

Creates an unsigned NFT mint transaction. For more granular control, you may create your own
[OperationTx](api_avm_operationtx.operationtx.md) manually (with their corresponding [TransferableInput](api_platformvm_inputs.transferableinput.md)s, [TransferableOutput](api_platformvm_outputs.transferableoutput.md)s, and [[TransferOperation]]s).
...
*Defined in [src/apis/avm/utxos.ts:815](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/avm/utxos.ts#L815)*
...
*Defined in [src/apis/avm/utxos.ts:702](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/avm/utxos.ts#L702)*
...
*Defined in [src/apis/avm/utxos.ts:623](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/avm/utxos.ts#L623)*
...
*Defined in [src/apis/avm/utxos.ts:404](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/avm/utxos.ts#L404)*
...
`transferOwner` | [SECPTransferOutput](api_avm_outputs.secptransferoutput.md) | - | A [SECPTransferOutput](api_platformvm_outputs.secptransferoutput.md) which specifies where the minted tokens will go |
`fromAddresses` | Buffer[] | - | The addresses being used to send the funds from the UTXOs [Buffer](https://github.com/feross/buffer) |
...
*Defined in [src/apis/avm/utxos.ts:159](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/avm/utxos.ts#L159)*
...
*Defined in [src/apis/avm/utxos.ts:155](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/avm/utxos.ts#L155)*
...
*Defined in [src/apis/avm/utxos.ts:119](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/avm/utxos.ts#L119)*
...
*Defined in [src/common/utxos.ts:529](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L529)*
...
*Defined in [src/common/utxos.ts:477](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L477)*
...
*Defined in [src/common/utxos.ts:416](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L416)*
...
*Defined in [src/common/utxos.ts:367](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L367)*
...
*Defined in [src/common/utxos.ts:346](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L346)*
...
*Defined in [src/common/utxos.ts:455](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L455)*
...
*Defined in [src/common/utxos.ts:428](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L428)*
...
*Defined in [src/apis/avm/utxos.ts:172](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/avm/utxos.ts#L172)*
...
*Defined in [src/common/utxos.ts:337](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L337)*
...
*Defined in [src/common/utxos.ts:392](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L392)*
...
*Defined in [src/common/utxos.ts:203](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L203)*
...
*Defined in [src/common/utxos.ts:515](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L515)*
...
*Defined in [src/common/utxos.ts:496](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L496)*
...
*Defined in [src/common/utxos.ts:578](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L578)*
...
*Defined in [src/apis/avm/utxos.ts:141](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/apis/avm/utxos.ts#L141)*
...
*Defined in [src/common/utxos.ts:284](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L284)*
...
*Defined in [src/common/utxos.ts:319](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L319)*
...
*Defined in [src/common/utxos.ts:169](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L169)*
...
*Defined in [src/common/utxos.ts:543](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L543)*
...
*Defined in [src/common/utxos.ts:558](https://github.com/ava-labs/avalanchejs/blob/ae78dee/src/common/utxos.ts#L558)*
