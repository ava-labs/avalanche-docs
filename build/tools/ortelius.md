...
Comenzando con la versión 2, las rutas de la API se fijarán por una etiqueta de versión, por `http://localhost:8080/v2`ejemplo.
...
| `caddress` | Una dirección codificada hex \(utilizada en la C-Chain\) | `0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7` |
| `chash` | Un hash codificado | `0xe5b935988317e8552e769ad92b6a2fd01ac8f0f90d8ffa4377e50fcb8d970077` |
...
| `intervalSize` | `string` | Valores | Ninguno | Ninguno |
...
Encuentra un bloque por su número.
...
### Lista Transacciones de C-Chain

Encuentra transacciones de C-Chain aceptadas.
...
| `hash` | `chash` | hash transacción | Ninguno | Ninguno |
| `blockStart` | `number` | Número de bloque de inicio incluido | Ninguno | N/A |
| `blockEnd` | `number` | Número de bloque exclusivo | Ninguno | N/A |
...
### Obtén una transacción de C-Chain Raw
...
La versión 1 de la API fue creada para soportar solo la X-chain, y no usó una versión prefix `/v1`\(\). Está disponible en el camino `/x`de la raíz, que es el extremo de vista general para solo la X-chain:
