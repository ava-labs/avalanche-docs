...
exports.rpcDataToBuffer = exports.bufferToRpcData = exports.rpcDataToBN = exports.rpcDataToNumber = exports.numberToRpcQuantity = exports.rpcQuantityToBN = exports.rpcQuantityToNumber = exports.rpcUnsignedInteger = exports.rpcAddress = exports.rpcHash = exports.rpcData = exports.rpcQuantity = void 0;
...
exports.rpcHash = new t.Type("HASH", (v) => Buffer.isBuffer(v) && v.length === HASH_LENGTH_BYTES, (u, c) => (isRpcHashString(u) ? t.success(ethereumjs_util_1.toBuffer(u)) : t.failure(u, c)), t.identity);
exports.rpcAddress = new t.Type("ADDRESS", (v) => Buffer.isBuffer(v) && v.length === ADDRESS_LENGTH_BYTES, (u, c) => (isRpcAddressString(u) ? t.success(ethereumjs_util_1.toBuffer(u)) : t.failure(u, c)), t.identity);
...
function rpcQuantityToBN(quantity) {
    ...
    const buffer = ethereumjs_util_1.toBuffer(quantity);
    return new ethereumjs_util_1.BN(buffer);
}
exports.rpcQuantityToBN = rpcQuantityToBN;
function numberToRpcQuantity(n) {
    errors_1.assertHardhatInvariant(typeof n === "number" || ethereumjs_util_1.BN.isBN(n), "Expected number");
...
function rpcDataToBuffer(data) {
    ...
    return ethereumjs_util_1.toBuffer(data);
}
...
function isRpcAddressString(u) {
    return typeof u === "string" && ethereumjs_util_1.isValidAddress(u);
}
