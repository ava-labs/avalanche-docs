...
const HardhatNetworkHDAccountsConfig = t.type(Object.assign({ mnemonic: io_ts_1.optional(t.string), accountsBalance: io_ts_1.optional(t.string) }, commonHDAccountsFields));
...
const HardhatNetworkConfig = t.type(Object.assign(Object.assign({}, commonNetworkConfigFields), { hardfork: io_ts_1.optional(t.keyof(lang_1.fromEntries(constants_1.HARDHAT_NETWORK_SUPPORTED_HARDFORKS.map((hf) => [hf, null])))), accounts: io_ts_1.optional(t.union([t.array(HardhatNetworkAccount), HardhatNetworkHDAccountsConfig])), blockGasLimit: io_ts_1.optional(t.number), throwOnTransactionFailures: io_ts_1.optional(t.boolean), throwOnCallFailures: io_ts_1.optional(t.boolean), allowUnlimitedContractSize: io_ts_1.optional(t.boolean), initialDate: io_ts_1.optional(t.string), loggingEnabled: io_ts_1.optional(t.boolean), forking: io_ts_1.optional(HardhatNetworkForkingConfig) }));
