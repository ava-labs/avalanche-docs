...
exports.rpcNewBlockTagObjectWithHash = t.type({
    ...
    requireCanonical: io_ts_1.optional(t.boolean),
});
...
exports.optionalRpcNewBlockTag = io_ts_1.optional(exports.rpcNewBlockTag);
...
exports.optionalRpcOldBlockTag = io_ts_1.optional(exports.rpcOldBlockTag);
