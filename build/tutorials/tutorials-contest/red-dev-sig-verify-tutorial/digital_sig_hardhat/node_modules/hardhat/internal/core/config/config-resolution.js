...
function resolveHardhatNetworkConfig(hardhatNetworkConfig = {}) {
    ...
    const blockGasLimit = (_d = hardhatNetworkConfig.blockGasLimit) !== null && _d !== void 0 ? _d : clonedDefaultHardhatNetworkParams.blockGasLimit;
    const gas = (_e = hardhatNetworkConfig.gas) !== null && _e !== void 0 ? _e : blockGasLimit;
    const initialDate = (_f = hardhatNetworkConfig.initialDate) !== null && _f !== void 0 ? _f : new Date().toISOString();
