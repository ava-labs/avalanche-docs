...
Esto proporciona la primera control key  \(de nuevo, en realidad da la _dirección_ de la primera control key\). The key is held by the user we just specified.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA3NDcyODMwN119
-->