...
Nombra tu key pair`avalanche`. Si tu máquina local tiene MacOS o Linux, selecciona el formato de archivo `pem` . Si es Windows, utilice el formato de archivo `ppk` . Opcionalmente, puede agregar etiquetas a el key pair para ayudar con el seguimiento.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMDg1NDI5NjEsLTcyMDY4NDY3Niw4Nj
EwOTUzMDNdfQ==
-->