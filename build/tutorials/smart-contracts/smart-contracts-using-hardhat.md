...
Next, you'll need to install [AvalancheGo](https://github.com/ava-labs/avalanchego), which is our full node written in Golang, and [Avash](https://docs.avax.network/build/tools/avash), our local test network runner. Together, you can deploy private local networks and run tests on them. Installation instructions are in their respective repositories.
...
When you deploy to `avash`, `fuji` or `mainnet` you can add your private key(s) as an array to the respective environment's `accounts` field in [hardhat.config.js](https://github.com/ava-labs/avalanche-smart-contract-quickstart/blob/master/hardhat.config.js).
...
[package.json](https://github.com/ava-labs/avalanche-smart-contract-quickstart/blob/master/package.json) has a `fund-cchain-addresses` script. [fund-cchain-addresses](https://github.com/ava-labs/avalanche-smart-contract-quickstart/blob/master/scripts/fund-cchain-addresses.js) will fund each of the C-Chain `accounts` on the `avash` network with 1000 AVAX.
...
We now have a token deployed at `0x789a5FDac2b37FCD290fb2924382297A6AE65860`. The `constructor` function of [this token](https://github.com/ava-labs/avalanche-smart-contract-quickstart/blob/master/contracts/Coin.sol#L15) `mint`s the `TOTAL_BALANCE` to the account which called the contract which is the first address in the `avash` `accounts` array in [hardhat.config.js](https://github.com/ava-labs/avalanche-smart-contract-quickstart/blob/master/hardhat.config.js).
...
<div><img src='../../../img/sc_qs_account1.png' alt='Account 1' width='400px'></div>

<div><img src='../../../img/sc_qs_account2.png' alt='Account 2' width='400px'></div>
...
<div><img src='../../../img/sc_qs_add-token1.png' alt='Add Token 1' width='400px'></div>

<div><img src='../../../img/sc_qs_add-token2.png' alt='Add Token 2' width='400px'></div>

<div><img src='../../../img/sc_qs_add-token3.png' alt='Add Token 3' width='400px'></div>
...
<div><img src='../../../img/sc_qs_add-token4.png' alt='Add Token 4' width='400px'></div>
...
<div><img src='../../../img/sc_qs_send-sym1.png' alt='Send SYM 1' width='400px'></div>

<div><img src='../../../img/sc_qs_send-sym2.png' alt='Send SYM 2' width='400px'></div>

Lastly note that the 2nd account has 507 `SYM`.

<div><img src='../../../img/sc_qs_send-sym3.png' alt='Send SYM 3' width='400px'></div>

## Conclusion

Now you know how to use Hardhat in your workflow to let you quickly and easily deploy and test smart contracts on the Avalanche Platform, freeing you to concentrate on developing your DApps, instead of fiddling with the tools.

## Contact and Help

We'd like to hear from you! If you hve any questions, problems, or ideas, you can reach out to us at [Discord](https://chat.avalabs.org/).
