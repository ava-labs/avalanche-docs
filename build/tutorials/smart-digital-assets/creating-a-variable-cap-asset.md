...
Our asset will exist on the X-Chain, so to create our asset we’ll call `avm.createVariableCapAsset`, which is a method of the [X-Chain’s API](../../apis/exchange-chain-x-chain-api.md).
