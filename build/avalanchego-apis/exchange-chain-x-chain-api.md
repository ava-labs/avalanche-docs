...
* `sourceChain` es el ID o alias de l aof the chain the AVAX is being imported from. To import funds from the P-Chain, use `"P"`.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDQ5NjQxNTE3LDU1MzU3MTgxOSwxODM1ND
