...
* `groupID` es el grupo NFT desde donde envía el NFT. LA creación de NFT permite múltiples grupos con un NFT creation allows multiple groups under each NFT ID. You can issue multiple NFTs to each group.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTc2MDExNDU1LDU1MzU3MTgxOSwxODM1ND
