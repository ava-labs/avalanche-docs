...
* El activo se envía de direcciónes controladas por el usuairThe asset is sent from addresses controlled by user `username`. \(Of course, that user will need to hold at least the balance of the asset being sent.\)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA2NjQ2NjM5Niw1NTM1NzE4MTksMTgzNT
