...
* `groupID` es el grupo NFT group desde el que fue enviado el NFT from which to send the NFT. NFT creation allows multiple groups under each NFT ID. You can issue multiple NFTs to each group.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg1NjgzMjAwMSw1NTM1NzE4MTksMTgzNT
