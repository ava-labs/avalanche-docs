        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                'build/tutorials/nodes-and-staking/README',
                {
                  type: 'category',
                  label: 'Build',
                  items: [
                    'build/tutorials/nodes-and-staking/build/set-up-node-with-installer',
                    'build/tutorials/nodes-and-staking/build/run-avalanche-node',
                    {
                      type: 'category',
                      ...
                      items: [
                        {
                          type: 'autogenerated',
                          dirName: 'build/tutorials/nodes-and-staking/build/cloud',
                        },
                      ],
                    },
                  ],
                },
                {
                  ...
                  items: [
                    {
                      type: 'autogenerated',
                      dirName: 'build/tutorials/nodes-and-staking/maintain',
                    },
                  ],
                },
                {
                  ...
                  items: [
                    {
                      type: 'autogenerated',
                      dirName: 'build/tutorials/nodes-and-staking/validate',
                    },
                  ],
                },
              ],
