...
Cada blockchain ese validada por una [subnet](../../../aprende/platform-overview/#subnets). Antes de que puedas crear una blockchain, necesitarás una subnet para validarla. También puedes usar una subnet que ya exista si tienes un número suficiente de sus control keys.
...
Puedes interactuar con esta nueva instancia de la AVM casi de la misma manera que interactuarías con la [X-Chain](../../../aprende/platform-overview/#exchange-chain-x-chain). Hay dos pequeñas diferencias:
