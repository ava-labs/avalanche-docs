...
![AWS Management Console.png](https://github.com/ava-labs/avalanche-docs/tree/6463c5cada7c624c554c84a60eccb50b528afe14/.gitbook/activos/AWS-Management-Console.png)
...
Añade una etiqueta al nuevo grupo de seguridad con la clave `Name` y el valor `Avalanche Security Group`. Esto nos permitirá saber qué es este grupo de seguridad cuando lo veamos en la lista de grupos de seguridad. ![Tag the security group so you can identify it later.](https://miro.medium.com/max/961/1*QehD3uyplkb4RPxddP1qkg.png)
