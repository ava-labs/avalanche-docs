...
Has completado [Iniciando en Avalanche](../../getting-started.md) y estás familiarizado con la [Arquitectura de Avalanche](../../../aprende/platform-overview/). En este tutorial, usamos la [Colección de Postman de Avalanche](https://github.com/ava-labs/avalanche-postman-collection) para ayudarnos a hacer llamados a la API.
