...
La API permite a los clientes interactuar con la cadena P o [P-Chain](../../aprende/platform-overview/#platform-chain-p-chain), que mantiene al conjunto de [validadores](../../aprende/platform-overview/staking.md#validators) de Avalanche y maneja la creación de cadenas de bloques.
