      ...
      <div className="w-full max-w-fd-container bg-transparent md:px-10 dark:-mb-32 dark:mt-[-4.75rem] dark:pb-32 dark:pt-[4.75rem]">
        <div className="lg:max-w-8xl mx-auto grid max-w-full grid-cols-1 items-center gap-y-8 md:gap-y-16 px-0 py-8 lg:grid-cols-2 lg:gap-x-8 lg:px-8 xl:gap-x-16 xl:px-12">
              ...
              <div className="mt-8 flex flex-col gap-4 items-center lg:items-start lg:flex-row">
                ...
                >
                  <span className="absolute inset-0 overflow-hidden rounded-xs">
                    <span className="absolute inset-0 rounded-xs bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(56,189,248,0.6)_0%,rgba(56,189,248,0)_75%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100"></span>
                  </span>
                  ...
                  <span className="absolute -bottom-0 left-[1.125rem] h-px w-[calc(100%-2.25rem)] bg-linear-to-r from-emerald-400/0 via-stone-800/90 to-emerald-400/0 transition-opacity duration-500 group-hover:opacity-40"></span>
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="hidden xl:block lg:static xl:pl-10">
            <div className="relative">
              <div className="absolute inset-0 rounded-none bg-linear-to-tr opacity-5 blur-lg" />
              <div className="absolute inset-0 rounded-none bg-linear-to-tr opacity-5" />
              <Sponsors />
            </div>
          </div>
        </div>
