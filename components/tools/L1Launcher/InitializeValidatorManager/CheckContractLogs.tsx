    ...
    return (
        <div className="rounded-lg border border-gray-200 mb-4">
            <div className="flex items-center justify-between p-4 border-b border-gray-200">
                <h2 className="text-lg font-medium">Contract Events</h2>
            </div>
                ...
                <div className="space-y-2 mb-6">
                    <div className="flex items-center">
                        <div className={`w-5 h-5 rounded-full mr-3 flex items-center justify-center
                            ${hasInitialized ? 'bg-green-500' : 'bg-gray-100'}`}>
                            {hasInitialized && (
                                <span className="text-white text-sm">✓</span>
                            )}
                        </div>
                        <span className="text-gray-700">PoAValidatorManager emitted Initialized event</span>
                    </div>

                    <div className="flex items-center">
                        <div className={`w-5 h-5 rounded-full mr-3 flex items-center justify-center
                            ${hasInitialValidator ? 'bg-green-500' : 'bg-gray-100'}`}>
                            {hasInitialValidator && (
                                <span className="text-white text-sm">✓</span>
                            )}
                        </div>
                        <span className="text-gray-700">PoAValidatorManager emitted InitialValidatorCreated event</span>
                    </div>
                </div>
