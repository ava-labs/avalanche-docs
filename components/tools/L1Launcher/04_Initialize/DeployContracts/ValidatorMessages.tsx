...
import ValidatorMessagesABI from "../contract_compiler/compiled/ValidatorMessages.json";
import { getChainConfig } from './utils';

export function ValidatorMessagesDeployer() {
    const { evmChainId, chainId, getCChainRpcEndpoint, setValidatorMessagesAddress, validatorMessagesAddress } = useL1LauncherWizardStore();
