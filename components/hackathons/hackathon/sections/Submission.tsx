  ...
  return (
    <section className="py-16 text-black dark:text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4">
        ...
        <div className="bg-zinc-200 dark:bg-zinc-900 p-6 shadow-md flex flex-col items-start rounded-tl-md rounded-bl-md">
          <Calendar color={resolvedTheme == 'dark' ? '#A7A7B0' : '#6F6F77'} size={24} />
        ...
        <div className="bg-zinc-700 dark:bg-zinc-800 p-6 shadow-md flex flex-col items-start">
          <Check color={resolvedTheme == 'dark' ? '#A7A7B0' : '#D1D1D7'} size={24} />
        ...
        <div className="bg-zinc-200 dark:bg-zinc-900 p-6 shadow-md flex flex-col items-start">
          <Trophy color={resolvedTheme == 'dark' ? '#A7A7B0' : '#6F6F77'} size={24} />
        ...
        <div className="bg-zinc-700 dark:bg-zinc-800 p-6 shadow-md flex flex-col items-start">
          <Rocket color={resolvedTheme == 'dark' ? '#A7A7B0' : '#D1D1D7'} size={24} />
      ...
      <div className="flex justify-center mt-8">
        <Button variant={'secondary'} className="w-1/3 bg-red-500 rounded-md text-zinc-100">
