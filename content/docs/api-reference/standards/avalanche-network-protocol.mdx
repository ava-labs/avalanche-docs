...
Avalanche network defines the core communication format between Avalanche nodes. It uses the [primitive serialization](/api-reference/standards/serialization-primitives) format for payload packing.
