...
[secp256k1](/api-reference/standards/cryptography-primitives#secp256k1-addresses) for cryptographic
user identification.
...
A [secp256k1](/api-reference/standards/cryptography-primitives#secp256k1-addresses) mint output is
...
A [secp256k1](/api-reference/standards/cryptography-primitives#secp256k1-addresses) transfer output
...
A [secp256k1](/api-reference/standards/cryptography-primitives#secp256k1-addresses) transfer input
...
A [secp256k1](/api-reference/standards/cryptography-primitives#secp256k1-addresses) mint operation
...
Let's make a [secp256k1](/api-reference/standards/cryptography-primitives#secp256k1-addresses) mint
operation with:
...
A [secp256k1](/api-reference/standards/cryptography-primitives#secp256k1-addresses) credential
