...
[primitive serialization](/api-reference/standards/serialization) format for packing and
[secp256k1](/api-reference/standards/cryptography#secp256k1-addresses) for cryptographic
user identification.
...
- **`Output`** is an output, as defined
  [below](/api-reference/x-chain/transaction-format#outputs). Outputs have four possible types:
  [`SECP256K1TransferOutput`](/api-reference/x-chain/transaction-format#secp256k1-transfer-output),
  [`SECP256K1MintOutput`](/api-reference/x-chain/transaction-format#secp256k1-mint-output),
  [`NFTTransferOutput`](/api-reference/x-chain/transaction-format#nft-transfer-output)
  and [`NFTMintOutput`](/api-reference/x-chain/transaction-format#nft-mint-output).
...
[`SECP256K1TransferOutput`](/api-reference/x-chain/transaction-format#secp256k1-transfer-output),
[`SECP256K1MintOutput`](/api-reference/x-chain/transaction-format#secp256k1-mint-output),
[`NFTTransferOutput`](/api-reference/x-chain/transaction-format#nft-transfer-output) and
[`NFTMintOutput`](/api-reference/x-chain/transaction-format#nft-mint-output).

## SECP256K1 Mint Output

A [secp256k1](/api-reference/standards/cryptography#secp256k1-addresses) mint output is
...
A [secp256k1](/api-reference/standards/cryptography#secp256k1-addresses) transfer output
...
A [secp256k1](/api-reference/standards/cryptography#secp256k1-addresses) transfer input
...
A [secp256k1](/api-reference/standards/cryptography#secp256k1-addresses) mint operation
...
- **`AddressIndices`** is a list of unique ints that define the private keys
  ...
  [UTXO](/api-reference/x-chain/transaction-format#utxo). Each UTXO has an array of
...
Let's make a [secp256k1](/api-reference/standards/cryptography#secp256k1-addresses) mint
operation with:
...
- **`AddressIndices`** is a list of unique ints that define the private keys
  ...
  that can spend the UTXO. Each int represents the index in this address array
  that will sign this transaction. The array must be sorted low to high.
- **`NFTTransferOutput`** is the output of this operation and must be an [NFT Transfer Output](/api-reference/x-chain/transaction-format#nft-transfer-output). This
...
- **`Outputs`** is a variable length array of
  [outputs](/api-reference/x-chain/transaction-format#outputs), as defined above.
...
A [secp256k1](/api-reference/standards/cryptography#secp256k1-addresses) credential
...
An NFT credential is the same as an [secp256k1 credential](/api-reference/x-chain/transaction-format#secp256k1-credential) with a
...
[`CreateAssetTx`](/api-reference/x-chain/transaction-format#what-unsigned-create-asset-tx-contains),
[`OperationTx`](/api-reference/x-chain/transaction-format#what-unsigned-operation-tx-contains),
[`ImportTx`](/api-reference/x-chain/transaction-format#what-unsigned-import-tx-contains),
and
[`ExportTx`](/api-reference/x-chain/transaction-format#what-unsigned-export-tx-contains).
They all embed
[`BaseTx`](/api-reference/x-chain/transaction-format#what-base-tx-contains), which
...
- **`Outputs`** is an array of [transferable output objects](/api-reference/x-chain/transaction-format#transferable-output). Outputs must
  ...
  fee.
- **`Inputs`** is an array of [transferable input objects](/api-reference/x-chain/transaction-format#transferable-input). Inputs must be
...
- **`InitialStates`** is a variable length array that defines the feature
  extensions this asset supports, and the [initial state](/api-reference/x-chain/transaction-format#initial-state) of those feature
  extensions.
...
- **`Credentials`** is an array of
  [credentials](/api-reference/x-chain/transaction-format#credentials). Each credential
...
- **`Output`** is the output object that created this UTXO. The serialization of
  Outputs was defined above. Valid output types are [SECP Mint Output](/api-reference/x-chain/transaction-format#secp256k1-mint-output), [SECP Transfer Output](/api-reference/x-chain/transaction-format#secp256k1-transfer-output),
  [NFT Mint Output](/api-reference/x-chain/transaction-format#nft-mint-output), [NFT Transfer Output](/api-reference/x-chain/transaction-format#nft-transfer-output).
