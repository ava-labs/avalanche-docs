...
The P-Chain API allows clients to interact with the [P-Chain](https://github.com/learn/avalanche/avalanche-platform.md#p-chain), which maintains Avalanche’s validator set and handles blockchain creation.
...
Not recommended for use on Mainnet. See warning notice in [Keystore API](https://github.com/api-reference/keystore-api).
...
See [here](https://github.com/nodes/validate/add-a-validator.md) for information on adding a validator to a
Subnet.
