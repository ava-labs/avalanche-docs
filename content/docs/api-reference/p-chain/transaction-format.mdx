...
or `P-Chain`. This document uses the [primitive serialization](/api-reference/standards/serialization) format for packing and
...
A [secp256k1](/api-reference/standards/cryptography#secp256k1-addresses) output owners
