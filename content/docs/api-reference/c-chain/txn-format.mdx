...
transactions in `Coreth`. This document uses the [primitive serialization](/api-reference/standards/serialization-primitives) format for packing and
[secp256k1](/api-reference/standards/cryptographic-primitives#cryptography-in-the-avalanche-virtual-machine)
