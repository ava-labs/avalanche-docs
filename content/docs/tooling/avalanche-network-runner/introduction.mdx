...
See the [Avalanche-CLI documentation](/docs/avalanche-l1s/deploy-a-avalanche-l1/local-network) for details about how to create and run Avalanche L1s with our _Avalanche-CLI_ tool.
