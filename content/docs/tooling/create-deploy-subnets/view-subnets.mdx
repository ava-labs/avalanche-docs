...
You can list the Subnets you've created with: `avalanche blockchain list`
...
```bash
> avalanche blockchain describe firstblockchain
...
```bash
> avalanche blockchain describe firstblockchain --genesis
{
    "config": {
        "chainId": 12345,
        "homesteadBlock": 0,
