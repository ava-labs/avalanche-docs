...
After [installing Postman](/docs/tooling/avalanche-go-postman-collection/setting-up-postman#setup) and importing the [Avalanche collection](/docs/tooling/avalanche-go-postman-collection/setting-up-postman#collection-import), you can choose an API to make the call.
...
<Callout title="Note">
Data visualization is available for a number of methods. Learn how to use it with the help of [this](/docs/tooling/avalanche-go-postman-collection/data-visualization) guide.
</Callout>
...
<Callout title="Note">
Find out more about variables [here](/docs/tooling/avalanche-go-postman-collection/variables).
</Callout>
