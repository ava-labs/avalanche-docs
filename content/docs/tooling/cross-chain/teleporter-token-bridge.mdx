...
Network. We will name our Avalanche L1 `testSubnet`.

- To create a Teleporter-enabled Avalanche L1 configuration, [visit here](/tooling/cli-cross-chain/teleporter-on-local-networks.md#create-avalanche-l1-configurations)
- To deploy a Teleporter-enabled Avalanche L1, [visit here](/tooling/cli-cross-chain/teleporter-on-local-networks.md#deploy-the-avalanche-l1s-to-local-network)
...
`0x7DD1190e6F6CE8eE13C08F007FdAEE2f881B45D0` in our Avalanche L1 `testSubnet`.
...
address in our Avalanche L1 `testSubnet`. Note that we will be using the Home contract address `0x4Ac1d98D9cEF99EC6546dEd4Bd550b0b287aaD6D`
...
`subnet_testSubnet_airdrop` should now have 100 TOK tokens in our Avalanche L1 `testSubnet` and our EWOQ
