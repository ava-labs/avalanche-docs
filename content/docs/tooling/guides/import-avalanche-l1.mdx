---
title: Import a Avalanche L1
description: Learn how to import a avalanche-l1 into Avalanche-CLI.
---
...
To achieve this integration, this guide demonstrates the process of importing a Avalanche L1 to the Avalanche-CLI to enable better management of the Avalanche L1's configuration. This how-to uses the WAGMI Avalanche L1 deployed on Fuji Testnet as the example Avalanche L1.
...
If the query succeeded, the wizard jumps to prompt for the Avalanche L1 ID.
...
From the [Testnet Avalanche L1 Explorer](https://subnets-test.avax.network/WAGMI) you can see that WAGMI's Avalanche L1 ID is `28nrH5T2BMvNrWecFcV3mfccjs6axM1TVyqe79MCv2Mhs8kxiY`:
