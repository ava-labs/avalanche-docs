...
[here](/api-reference/standards/guides/issuing-api-calls.md). Namely, use the following end points for
...
[X-Chain](/api-reference/x-chain/api.md), [P-Chain](/api-reference/p-chain/api.md),
[C-Chain](/api-reference/c-chain/api.md), and full archival for the Primary Network.
However, it doesn't support [Index APIs](/api-reference/index-api.md), which includes
