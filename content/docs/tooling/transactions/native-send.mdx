...
- Install the [Avalanche CLI](https://build.avax.network/docs/tooling/guides/get-avalanche-cli).
- Use the CLI to [create a key](https://build.avax.network/docs/tooling/avalanche-cli#key-create).
...
- *Optionally*, you can [export](https://build.avax.network/docs/tooling/avalanche-cli#key-export) your private key for use in scripting or other tools. 
...
This command and all of its flags are documented [here](https://build.avax.network/docs/tooling/avalanche-cli#key-transfer).
...
After a successful transfer, you can check your CLI keys' balances with the [command](https://build.avax.network/docs/tooling/avalanche-cli#key-list): `avalanche key list`.
