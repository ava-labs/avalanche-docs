...
- (Ignore for Devnet) Set up a key to be able to pay for transaction Fees, as described [here](/avalanche-l1s/deploy-a-avalanche-l1/fuji-testnet).
...
Let's create a Avalanche L1 called `<blockchainName>`, with custom VM binary and genesis.
