---
title: Run Load Test
description: This page demonstrates how to run load test on a Avalanche L1 deployed on a cluster of cloud-based validators using Avalanche-CLI.
---

# Run Load Test With Avalanche-CLI

This page demonstrates how to run load test on a Avalanche L1 deployed on a cluster of cloud-based validators using Avalanche-CLI.
...
- Deployed a Avalanche L1 into the cluster
...
We will use an example of running load test on a Avalanche L1 running custom VM MorpheusVM built with 
