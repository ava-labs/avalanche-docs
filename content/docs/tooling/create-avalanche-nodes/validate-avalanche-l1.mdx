...
This page demonstrates how to configure nodes to validate an Avalanche L1. Avalanche L1 Validation via Avalanche-CLI is currently only supported on Fuji and Devnet.
