...
AvalancheJS is a JavaScript Library for interfacing with the [Avalanche](https://docs.avax.network/tooling/avalanche-js) Platform. It is built using TypeScript and intended to support both browser and Node.js. The AvalancheJS library allows you to issue commands to the Avalanche node APIs.
