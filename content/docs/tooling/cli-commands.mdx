---
title: CLI Commands
description: List of all commands supported by Avalanche-CLI.
---
...
Refer to https://build.avax.network/docs/nodes/maintain/chain-config-flags#subnet-chain-configs for related documentation.
...
- [`whitelist`](#whitelist): (ALPHA Warning) The whitelist command suite provides a collection of tools for granting access to the cluster.
	...
	If no params provided it detects current user IP automatically and whitelists it
