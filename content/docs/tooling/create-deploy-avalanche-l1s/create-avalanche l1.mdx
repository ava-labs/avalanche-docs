---
title: Create a Avalanche L1
description: This page demonstrates how to create a Avalanche L1 using Avalanche-CLI.
---

This tutorial walks you through the process of using Avalanche-CLI to create a Avalanche L1, deploy it to a local network, and connect to it with Core wallet.
