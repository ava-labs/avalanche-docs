...
- 1+ nodes running and fully bootstrapped on `Fuji` Testnet. Check out the section [Nodes](/nodes) on how to run a node and become a validator.
...
<Callout title="Note">
With more data on `Fuji`, it may take a while to bootstrap `Fuji` Testnet from scratch. You can use [State-Sync](/nodes/chain-configs/c-chain#state-sync-enabled) to shorten the time for bootstrapping.
</Callout>
...
|         PARAMETER          |                       VALUE                        |
+----------------------------+----------------------------------------------------+
| Blockchain Name                | testblockchain                                         |
+----------------------------+----------------------------------------------------+
| ChainID                    | 3333                                               |
+----------------------------+----------------------------------------------------+
| Token Name                 | TST                                               |
...
<Callout title="Note">
Before a node can be a validator on an Avalanche L1, the node is required to already be a validator on the primary network, which means that your node has **fully bootstrapped**.
