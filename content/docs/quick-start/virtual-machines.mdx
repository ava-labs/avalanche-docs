...
To get started, create a VM out-of-the-box with the [Subnet-EVM](/docs/avalanche-l1s/c-chain-or-avalanche-l1) in Solidity, or design a custom VM with languages like Golang, Rust, and many more.
