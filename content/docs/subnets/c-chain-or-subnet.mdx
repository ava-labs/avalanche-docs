---
title: C-Chain or Subnet?
description: Learn key concepts to decide when to build on a Subnet vs. C-Chain.
---

In this article, we discuss often-overlooked differentiating characteristics of Subnets, with a primary focus on EVM-based applications. The goal is to identify the pros and cons of building an app on [C-Chain](/docs/learn/primary-network#c-chain) versus [Subnet-EVM](https://github.com/ava-labs/subnet-evm), and help developers make more informed decisions.
