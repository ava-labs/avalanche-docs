...
`git clone git:ava-labs/subnet-evm.git`
...
Open a text editor and copy the preceding text into a file called `custom_genesis.json`. For full breakdown of the genesis file, see the [Genesis File](https://docs.avax.network/subnets/upgrade/customize-subnet#genesis).
