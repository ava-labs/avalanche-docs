...
You can verify that your Subnet has deployed correctly by querying the local node to see what Subnets it's running. You need to use the [`getNodeVersion`](/docs/api-reference/info-api#infogetnodeversion) endpoint. Try running this curl command:
