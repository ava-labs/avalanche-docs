...
Please refer to [Customize a Subnet](/subnets/upgrade/customize-subnet#network-upgrades-enabledisable-precompiles) for a detailed discussion of possible precompile upgrade parameters.
