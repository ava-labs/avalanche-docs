...
- Set up [WAGMI](/subnets/wagmi-case-study#adding-wagmi-to-core) and [Fuji](/dapps/end-to-end/fuji-workflow#set-up-fuji-network-on-core-optional) on Core
