...
For a simple upgrade you would need to place the new binary at `/usr/local/bin/`. If you run a Avalanche L1, you would also need to place the VM binary into `/home/avalanche/.avalanchego/plugins`.
