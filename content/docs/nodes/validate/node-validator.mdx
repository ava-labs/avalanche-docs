...
Get this info by calling [`info.getNodeID`](/api-reference/info-api#infogetnodeid):
...
Calling
[`platform.getPendingValidators`](/api-reference/p-chain/api#platformgetpendingvalidators)
