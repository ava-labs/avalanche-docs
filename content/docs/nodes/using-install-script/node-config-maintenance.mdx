...
Now you can [interact with your node](/api-reference/standards/guides/issuing-api-calls), [stake your tokens](/nodes/validate/what-is-staking), or level up your installation by setting up [node monitoring](/nodes/maintain/monitoring) to get a better insight into what your node is doing. Also, you might want to use our [Postman Collection](/tooling/avalanche-postman/add-postman-collection) to more easily issue commands to your node.
