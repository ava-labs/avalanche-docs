...
- To use a third-party service to host your node or run a validator, [see here](/nodes/on-third-party-services/amazon-web-services) for dedicated tutorials.  
...
To track an Avalanche L1 with your node, head to the [Avalanche L1 Node](/nodes/run-a-node/avalanche-l1-nodes) tutorial.