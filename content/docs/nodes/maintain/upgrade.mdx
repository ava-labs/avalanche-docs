...
If you installed your node using the [installer script](/nodes/using-install-script/installing-avalanche-go), to upgrade your node, just run the installer script again.
...
`git clone git:ava-labs/avalanchego.git`
