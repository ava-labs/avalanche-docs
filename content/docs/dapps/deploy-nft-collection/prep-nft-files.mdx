...
NOTE: Some projects start file names with `0`, and others with `1`. That choice will need to be consistent with the smart contract code. To be consistent with [this ERC-721 tutorial](/dapps/deploy-nft-collection/deploy-erc-721), we'll name this file `0`.
