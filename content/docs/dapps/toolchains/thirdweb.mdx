...
4. In the `contracts` folder, you will find the smart contract written in Solidity.
    ...
    contract; which implements [`ERC721A`](https://github.com/thirdweb-dev/contracts/blob/b1a61489a6f67b37397f517e46fa29f8c43f3a95/contracts/eip/ERC721A.sol#L2) standard.
