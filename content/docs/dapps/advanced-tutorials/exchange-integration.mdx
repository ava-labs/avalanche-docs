...
running, you can use the [node installation script](/docs/nodes/run/using-install-script/installing-avalanche-go) that automates installing
...
[here](/docs/learn/primary-network) (out of scope for a
