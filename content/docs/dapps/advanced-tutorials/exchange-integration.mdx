...
for C-Chain API [here](/api-reference/c-chain/api).
...
- [Core and Remix](/dapps/smart-contracts/remix-deploy)
- [thirdweb](/dapps/smart-contracts/toolchains/thirdweb)
- [Hardhat](/dapps/smart-contracts/toolchains/hardhat)
