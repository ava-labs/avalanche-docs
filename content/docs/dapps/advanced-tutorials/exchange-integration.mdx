...
running, you can use the [node installation script](/nodes/run/using-install-script/installing-avalanche-go) that automates installing
...
[here](/nodes/chain-configs/c-chain).
...
for C-Chain API [here](/api-reference/c-chain/api.md).
...
- The detailed dynamic gas fee can be found [here](/api-reference/standards/guides/txn-fees#c-chain-fees).
...
- [Core and Remix](/dapps/smart-contracts/remix-deploy.md)
- [thirdweb](/dapps/smart-contracts/toolchains/thirdweb.md)
- [Hardhat](/dapps/smart-contracts/toolchains/hardhat.md)
...
[here](/learn/primary-network) (out of scope for a
