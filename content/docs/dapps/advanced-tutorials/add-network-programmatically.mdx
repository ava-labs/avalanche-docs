...
Check out the [README](https://github.com/ava-labs/avalanche-dapp-sdks/blob/alpha-release/packages/web3-react-core-connector/README.md) to see details how this works and use it to fit your needs.
