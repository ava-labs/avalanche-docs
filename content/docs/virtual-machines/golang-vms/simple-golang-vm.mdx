...
Registered handlers defined in `Service`. See [below](/virtual-machines/golang-vms/simple-golang-vm#api) for more on APIs.
...
Registers static handlers defined in `StaticService`. See [below](/virtual-machines/golang-vms/simple-golang-vm#static-api) for more on static APIs.
