...
These testnets are often the testbeds for any new native feature of the network itself, or any dapp or [Avalanche L1](/learn/avalanche-l1s) that is going live on the main network (Mainnet). For example, [Fuji](/learn/networks/fuji-testnet) network is the Testnet for Avalanche's Mainnet.
