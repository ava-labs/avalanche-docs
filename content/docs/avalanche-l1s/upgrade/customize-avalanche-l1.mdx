...
For blockchains created by or forked from Subnet-EVM, most [C-Chain configs](/nodes/chain-configs/c-chain) are applicable except [Avalanche Specific APIs](/nodes/chain-configs/c-chain#enabling-avalanche-specific-apis).
