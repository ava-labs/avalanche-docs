...
description: This tutorial walks you through the process of using Avalanche-CLI to create a Avalanche L1, deploy it on a local network, and add to Core wallet.
---
