...
description: As you begin your Avalanche L1 journey, it's useful to look at the lifecycle of taking a Avalanche L1 from idea to production.
---

Figure Out Your Needs[​](#figure-out-your-needs "Direct link to heading")
-------------------------------------------------------------------------

The first step of planning your Avalanche L1 is determining your application's needs. What features do you need that the Avalanche C-Chain doesn't provide? Perhaps you want your own gas token or only want to allow access to KYCed customers. [When to Build on a Avalanche L1 vs. on the C-Chain](/avalanche-l1s/c-chain-or-avalanche-l1) can help you make the decision.

### Decide What Type of Avalanche L1 You Want[​](#decide-what-type-of-avalanche-l1-you-want "Direct link to heading")

Once you've decided to use a Avalanche L1, you need to decide what type of Avalanche L1 to build. This means choosing a virtual machine (VM) to create your Avalanche L1 with. Broadly speaking, there are three types of VMs to choose from:
...
Subnet-EVM is far and away the safest and most popular choice to build your Avalanche L1 with. It has the most mature developer tooling and receives regular updates by the Ava Labs team.
...
Avalanche L1s are powered by gas tokens. When you build a Avalanche L1, you have the option to decide what token you use and optionally, how you distribute it. You may use AVAX, an existing C-Chain token, or a brand new token. You'll need to decide how much of the supply you want to use to reward validators, what kind of emitting schedule you want, and how much to airdrop. Blocks may burn transaction fees or give them to validators as a block reward.
