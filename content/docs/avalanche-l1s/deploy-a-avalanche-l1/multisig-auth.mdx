...
- Familiarity with process of [Deploying an Avalanche L1 on Testnet](/avalanche-l1s/deploy-a-avalanche-l1/fuji-testnet) and [Deploying a Permissioned Avalanche L1 on Mainnet](/avalanche-l1s/deploy-a-avalanche-l1/avalanche-mainnet)
