...
description: Learn how to run an Avalanche node that tracks a Avalanche L1.
---

This article describes how to run a node that tracks a Avalanche L1. It requires building AvalancheGo, adding Virtual Machine binaries as plugins to your local data directory, and running AvalancheGo to track these binaries.
