...
Detailed description of how to do this can be found in [Customize an Avalanche L1](/avalanche-l1s/upgrade/customize-avalanche-l1#network-upgrades-enabledisable-precompiles) tutorial. Here's a summary:
