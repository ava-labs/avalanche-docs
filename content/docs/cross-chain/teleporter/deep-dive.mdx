...
Alternatively for new Subnets, the `TeleporterMessenger` contract can be directly included in the genesis file as documented [here](https://github.com/ava-labs/teleporter/blob/main/contracts/teleporter/README.md#teleporter-messenger-contract-deployment).
