...
The `blockchainID` in Avalanche refers to the txID that created the blockchain on the Avalanche P-Chain ([docs](/docs/api-reference/p-chain/transaction-format#unsigned-create-chain-tx)).
