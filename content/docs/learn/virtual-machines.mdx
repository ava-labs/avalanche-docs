...
To get started, create a VM out-of-the-box with the [Subnet-EVM](/subnets/c-chain-or-subnet) in Solidity, or design a custom VM with languages like Golang, Rust, and many more.
