...
The Primary Network is a special [Subnet](/docs/learn/subnets) that runs three blockchains:
...
<Callout title="Note">
[Avalanche Mainnet](/docs/learn/networks/mainnet) is comprised of the Primary Network and all deployed Subnets.
</Callout>
...
The **P-Chain** is responsible for all validator and Subnet-level operations. The [P-Chain API](/docs/api-reference/p-chain/api) supports the creation of new blockchains and Subnets, the addition of validators to Subnets, staking operations, and other platform-level operations.
