...
description: Avalanche Avalanche L1 Explorer is an analytics tool for exploring Avalanche L1 transactions, addresses, statistics, and other platform activities.
...
1. **Visit Avalanche Explorer**: Head to the [Avalanche Avalanche L1 Explorer website](https://subnets.avax.network/) to start exploring the data.
