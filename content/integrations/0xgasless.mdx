...
3. **Funding The paymaster**: Follow the [documentation](https://docs.0xgasless.com/getting-started/quick-start-guide) and checkout the [0xGasless Dashboard](https://dashboard.0xgasless.com/) to create and fund the paymaster.
