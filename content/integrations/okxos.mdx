...
### Create a On-Chain Data Dashboard on Avalanche Primary Network

To create a on-chain data dashboard on the Avalanche Primary Network, you can follow the steps below:
...
When dealing with large data responses, such as when you uncomment the second address in the `createAccount.js` file, it is important to handle the response data efficiently in the `getAssets.js` file.
...
4. **Open the `getTx.js` file** and use the following JavaScript code to get the data of a transaction:
