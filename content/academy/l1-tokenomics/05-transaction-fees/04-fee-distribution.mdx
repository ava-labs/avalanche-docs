...
This mechanism can be also activated as a precompile. See [Changing Fee Reward Mechanisms](/docs/avalanche-l1s/upgrade/customize-avalanche-l1#changing-fee-reward-mechanisms) in Avalanche docs for more details
