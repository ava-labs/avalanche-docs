...
export function GithubEmbed({ filePath, user, repo, branch = "main", lang = "TS", maxHeight }: GithubEmbedProps) {
    ...
    return (
        <div className="my-4 border border-gray-200 rounded-md w-full overflow-hidden">
            <div style={{
            ...
            <div className="px-4 py-2 bg-gray-50 text-xs text-gray-600 border-t border-gray-200 rounded-b-md ">
                <a
